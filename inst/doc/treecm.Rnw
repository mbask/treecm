...
\begin{itemize}
  ...
  \item \verb!branchBiomassPineAsca!, tested on stone pine branches, 8-16 cm diameter, returns fresh weight
\end{itemize}
...
Note that one should pick an allometric equation that yields fresh mass of branches. Function \verb!branchBiomassPineAsca! returns fresh weight values for stone pine branches.
